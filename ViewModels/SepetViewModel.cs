...
namespace KonserBiletim.ViewModels
{
    public class SepetViewModel
    {
        ...
        public IEnumerable<KartViewModel> Kartlar { get; set; } = new List<KartViewModel>(); //odeme yaparken kullanıcıya ait kartlar arasından secim yapabilmesi icin kartları bu listeye aktardım
        public int SecilenKartID {  get; set; }
    }
}